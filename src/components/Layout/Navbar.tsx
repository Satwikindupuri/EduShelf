...
import { BookOpen, Home, Library, MessageSquare, User, LogOut, Menu, X } from 'lucide-react';
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-600 rounded-lg transition-all duration-200"
            >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white">
            ...
            <div className="border-t border-gray-200 pt-4 pb-3">
              ...
              <button
                onClick={handleSignOut}
                className="flex items-center space-x-3 w-full px-5 py-2 text-sm text-red-600 hover:bg-red-50"
              >
